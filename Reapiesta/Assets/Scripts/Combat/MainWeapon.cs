...
public class MainWeapon : MonoBehaviour
{
    ...
    void ShootStuff()
    {
        ...
        if (Physics.Raycast(camPos.position + (camPos.forward * 10), camPos.forward, out hit, rayLenght, ~LayerMask.GetMask("IgnoreRaycast", "IgnoreCam", "IgnoreTrigger", "ClothCollider")))
        {
